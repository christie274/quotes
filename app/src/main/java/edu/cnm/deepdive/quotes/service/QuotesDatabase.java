...
public abstract class QuotesDatabase extends RoomDatabase {
  ...
  private static class InstanceHolder {
    ...
    private static final QuotesDatabase INSTANCE = Room.databaseBuilder(context, QuotesDatabase.class, DB_NAME)
          ...
          public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            sourceDao.insert(source)
                ...
                Quote quote = new Quote();
                  ...
                  quote.setText("I would teach peace rather than war. I would include love rather than hate.");
